    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('councilLocation', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='main.councillocations')),
            ],
        ),
    ]
